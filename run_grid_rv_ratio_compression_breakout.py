...
grid_spec = GridSpec(
    param_grid={
        "compression_threshold": [0.60, 0.70, 0.80],
...
with open("grid_result_rv_ratio_compression_breakout.json", "w") as f:
    json.dump(summary, f, indent=2, default=str)

with open("grid_cells_rv_ratio_compression_breakout.json", "w") as f:
