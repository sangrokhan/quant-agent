...
spec_mod = importlib.util.spec_from_file_location(
    "strat", "strategies/2026-09-22_reverse_elder_impulse_neutral_transition.py"
)
...
gs = GridSpec(
    param_grid={"ema_window": [13, 21], "trend_window": [0, 100]},
...
with open("grid_cells_reverse_elder_impulse.json", "w") as f:
    json.dump(cells, f, indent=2, default=str)

# equity summary by param combo
