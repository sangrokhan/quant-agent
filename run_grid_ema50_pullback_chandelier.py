...
gspec = GridSpec(
    param_grid={
        "pullback_min_bars": [2, 3, 4],
        "breakout_atr_mult": [0.1, 0.25, 0.5],
        "chandelier_mult": [2.5, 3.0],
    },
...
with open("grid_summary_ema50_pullback_chandelier.json", "w") as f:
...
with open("grid_cells_ema50_pullback_chandelier.json", "w") as f:
