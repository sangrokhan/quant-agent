...
spec_path = "strategies/2026-09-14_adl_roc_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("adl_strat", spec_path)
...
configs = {
    "QQQ": ("equity", {"roc_window": 30, "deadband": 0.25, "leverage_cap": 0.4}),
    "SPY": ("equity", {"roc_window": 10, "deadband": 0.15, "leverage_cap": 0.4}),
...
with open("validators_adl_roc_sizing.json", "w") as f:
