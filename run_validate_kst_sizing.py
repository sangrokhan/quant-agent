...
spec_path = "strategies/2026-09-14_kst_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("kst_strat6", spec_path)
...
configs = {
    ...
    "BTC/USDT": ("crypto", {"sensitivity": 0.7, "deadband": 0.15, "leverage_cap": 0.3, "base_exposure": 0.15}),
...
with open("validators_kst_sizing.json", "w") as f:
