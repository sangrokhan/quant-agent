...
spec = importlib.util.spec_from_file_location("strat_3dcvg", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "max_stop_pct": [0.03, 0.05, 0.08],
...
with open("grid_summary_3dc_volgate.json", "w") as f:
...
with open("grid_cells_3dc_volgate.json", "w") as f:
