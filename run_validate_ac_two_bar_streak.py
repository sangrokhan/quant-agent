...
spec = importlib.util.spec_from_file_location("strat_ac2bar", "strategies/2026-09-24_ac_two_bar_streak.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

SYMBOL = "QQQ"
params = {"max_hold_days": 10}
...
grid_cells = json.load(open("grid_cells_ac_two_bar_streak.json"))
param_grid_results = {}
for c in grid_cells:
...
with open("validate_result_ac_two_bar_streak_qqq.json", "w") as f:
