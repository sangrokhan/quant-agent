...
with open("grid_summary_move_vix_divergence_sizing_dial.json", "w") as f:
    json.dump(summary, f, indent=2, default=str)
with open("grid_cells_move_vix_divergence_sizing_dial.json", "w") as f:
