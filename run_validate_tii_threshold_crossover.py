...
spec_mod_path = "strategies/2026-09-24_tii_threshold_crossover.py"
spec = importlib.util.spec_from_file_location("strat_tii", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(sma_period=40, entry_threshold=80, max_hold_days=30)
...
grid_cells = json.load(open("grid_cells_tii_threshold_crossover.json"))
...
with open(f"validate_result_tii_threshold_crossover_{symname}.json", "w") as f:
