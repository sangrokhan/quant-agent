...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-14_cg_oscillator_sizing_sma_trend.py")
spec = importlib.util.spec_from_file_location("cg_strat_grid", spec_path)
...
with open("grid_result_cg_oscillator_sizing.json", "w") as f:
