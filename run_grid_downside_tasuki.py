...
spec_mod_path = "strategies/2026-09-21_downside_tasuki_gap_short.py"
spec = importlib.util.spec_from_file_location("strat_dtg", spec_mod_path)
...
with open("grid_summary_downside_tasuki_gap_short.json", "w") as f:
...
with open("grid_cells_downside_tasuki_gap_short.json", "w") as f:
