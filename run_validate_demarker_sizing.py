...
spec_path = "strategies/2026-09-14_demarker_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("demarker_strat", spec_path)
...
configs = {
    "QQQ": ("equity", {"sensitivity": 1.0, "deadband": 0.25, "leverage_cap": 1.0}),
    "SPY": ("equity", {"sensitivity": 1.0, "deadband": 0.25, "leverage_cap": 1.0}),
    "BTC/USDT": ("crypto", {"sensitivity": 1.0, "deadband": 0.25, "leverage_cap": 0.4}),
    "ETH/USDT": ("crypto", {"sensitivity": 1.0, "deadband": 0.25, "leverage_cap": 0.4}),
}
...
with open("validators_demarker_sizing.json", "w") as f:
