...
spec_mod_path = "strategies/2026-09-24_renko_brick_trend.py"
spec = importlib.util.spec_from_file_location("strat_renko", spec_mod_path)
...
params = dict(brick_atr_mult=1.0, min_consecutive_bricks=1, max_hold_days=20)
...
grid_cells = json.load(open("grid_cells_renko_brick_trend.json"))
...
with open(f"validate_result_renko_brick_trend_{SYMBOL}.json", "w") as f:
