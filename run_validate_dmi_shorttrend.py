...
best_params = {"trend_window": 25, "dmi_sensitivity": 0.5, "deadband": 0.15}
...
for symbol in ["QQQ", "SPY"]:
    ...
    for tw in [20, 25, 30]:
        for sens in [0.4, 0.5, 0.6]:
            r = strat.generate_returns(price_df, trend_window=tw, dmi_sensitivity=sens, deadband=0.15)
            try:
                import vectorbt as vbt
...
with open("validators_dmi_shorttrend.json", "w") as f:
