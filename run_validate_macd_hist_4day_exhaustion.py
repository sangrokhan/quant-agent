...
spec = importlib.util.spec_from_file_location("strat", "strategies/2026-09-24_macd_hist_4day_exhaustion.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

best_params = dict(hist_decline_days=3, max_hold_days=10)
...
cells = json.load(open("grid_cells_macd_hist_4day_exhaustion.json"))
pgr = {}
for c in cells:
...
with open("validate_result_macd_hist_4day_exhaustion_qqq.json", "w") as f:
