...
spec = importlib.util.spec_from_file_location("strat", "strategies/2026-09-21_ema_13_48_crossover.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

best_params = dict(fast_window=13, slow_window=48)

df = load_equity("QQQ", datetime(2016, 1, 1), datetime(2026, 9, 1), interval="1d")
...
cells = json.load(open("grid_cells_ema1348.json"))
pgr = {}
for c in cells:
...
with open("validate_result_ema1348_qqq.json", "w") as f:
