...
strat = load_module(os.path.join(ROOT, "strategies", "2026-09-12_lrc_pullback_continuation.py"), "lrc_strat")
...
best_params = dict(lrc_window=80, pullback_window=8, slope_lag=5, max_hold_days=15)
...
for symbol in ["QQQ", "SPY"]:
    ...
    for lw in [60, 80, 100]:
        for pw in [5, 8, 12]:
            p2 = dict(lrc_window=lw, pullback_window=pw, slope_lag=5, max_hold_days=15)
...
with open(os.path.join(ROOT, "validators_lrc_pullback.json"), "w") as f:
