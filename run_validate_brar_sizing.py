...
spec_path = "strategies/2026-09-16_brar_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("brar_strat", spec_path)
...
configs = {
    "QQQ": {"loader": load_equity, "params": {"trend_window": 40, "brar_window": 26, "zscore_window": 60,
             "base_exposure": 0.4, "sensitivity": 0.5, "leverage_cap": 1.0, "deadband": 0.30}},
    "SPY": {"loader": load_equity, "params": {"trend_window": 30, "brar_window": 26, "zscore_window": 80,
             "base_exposure": 0.4, "sensitivity": 0.3, "leverage_cap": 1.0, "deadband": 0.40}},
    "BTC/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "brar_window": 26, "zscore_window": 60,
             "base_exposure": 0.2, "sensitivity": 0.15, "leverage_cap": 0.5, "deadband": 0.20}},
    "ETH/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "brar_window": 26, "zscore_window": 60,
             "base_exposure": 0.2, "sensitivity": 0.1, "leverage_cap": 0.5, "deadband": 0.10}},
}
...
with open("validators_brar_sizing.json", "w") as f:
