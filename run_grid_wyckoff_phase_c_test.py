...
spec_mod_path = "strategies/2026-09-22_wyckoff_phase_c_test.py"
spec = importlib.util.spec_from_file_location("strat_wpc", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "range_width_pct": [0.12, 0.20],
        "test_volume_ratio": [0.5, 0.7, 0.9],
    },
...
with open("grid_summary_wyckoff_phase_c_test.json", "w") as f:
...
with open("grid_cells_wyckoff_phase_c_test.json", "w") as f:
