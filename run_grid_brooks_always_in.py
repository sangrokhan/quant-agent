...
spec_mod_path = "strategies/2026-09-22_brooks_always_in.py"
spec = importlib.util.spec_from_file_location("strat_brooks", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "trend_bar_pctile": [0.65, 0.75, 0.85],
        "ema_window": [10, 20, 50],
    },
...
with open("grid_summary_brooks_always_in.json", "w") as f:
...
with open("grid_cells_brooks_always_in.json", "w") as f:
