...
best_params = {"trend_window": 40, "mfi_sensitivity": 0.5, "deadband": 0.20}
...
for symbol in ["QQQ", "SPY"]:
    ...
    for tw in [35, 40, 45]:
        for sens in [0.4, 0.5, 0.6]:
            r = strat.generate_returns(price_df, trend_window=tw, mfi_sensitivity=sens, deadband=0.20)
            try:
                import vectorbt as vbt
...
with open("validators_mfi_shorttrend.json", "w") as f:
