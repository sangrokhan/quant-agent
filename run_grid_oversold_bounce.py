...
spec_mod_path = "strategies/2026-09-22_oversold_bounce_rsi_bb_volume_candle.py"
spec = importlib.util.spec_from_file_location("strat_ob", spec_mod_path)
...
with open("grid_summary_oversold_bounce_rsi_bb_volume_candle.json", "w") as f:
...
with open("grid_cells_oversold_bounce_rsi_bb_volume_candle.json", "w") as f:
