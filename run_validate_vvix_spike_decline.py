...
params = dict(spike_threshold=120, decline_lookback=3, normal_threshold=90, max_hold_days=20)

cells = json.load(open("grid_cells_vvix_spike_decline.json"))
...
for asset_class, symbol, loader in [
    ...
    df = loader(symbol, datetime(2016, 1, 1), datetime(2026, 9, 1))
...
with open("validators_vvix_spike_decline.json", "w") as f:
