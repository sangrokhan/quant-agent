...
spec_mod_path = "strategies/2026-09-22_elliott_abc_correction.py"
spec = importlib.util.spec_from_file_location("strat_abc", spec_mod_path)
...
with open("grid_summary_elliott_abc_correction.json", "w") as f:
...
with open("grid_cells_elliott_abc_correction.json", "w") as f:
