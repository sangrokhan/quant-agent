...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-16_trend_magic_dist_sizing_sma_trend.py")
...
with open("grid_result_trend_magic_dist_sizing.json", "w") as f:
