...
spec = importlib.util.spec_from_file_location("tmf_strat", spec_path)
...
configs = {
    "QQQ": ("equity", {"sensitivity": 0.5, "deadband": 0.15}),
    "SPY": ("equity", {"sensitivity": 0.7, "deadband": 0.30}),
    "BTC/USDT": ("crypto", {"sensitivity": 0.7, "deadband": 0.15}),
}
...
with open("validators_tmf_sizing.json", "w") as f:
