...
best_params = dict(atr_period=10, atr_mult=2.0, smooth_period=14)
...
# param sensitivity from grid cells (QQQ only, all vol regimes combined isn't directly
# per-config full-sample sharpe; recompute full-sample sharpe per param combo quickly)
import itertools
param_grid_results = {}
for ap in [10, 14]:
...
with open("validate_result_chande_kroll_stop_qqq.json", "w") as f:
