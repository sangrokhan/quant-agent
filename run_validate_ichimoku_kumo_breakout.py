...
spec_mod_path = "strategies/2026-09-22_ichimoku_kumo_breakout_kijun_trail.py"
spec = importlib.util.spec_from_file_location("strat_ichi", spec_mod_path)
...
params = dict(tenkan_window=7, kijun_window=26, senkou_b_window=52, senkou_shift=26, chikou_shift=26)
...
grid_cells = json.load(open("grid_cells_ichimoku_kumo_breakout_kijun_trail.json"))
...
with open("validate_result_ichimoku_kumo_breakout_kijun_trail_qqq.json", "w") as f:
