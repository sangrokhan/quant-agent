...
spec_mod_path = "strategies/2026-09-22_fib_golden_zone_rejection_rr.py"
spec = importlib.util.spec_from_file_location("strat_fibgz", spec_mod_path)
...
params = dict(swing_lookback=20, rr_multiple=2.0, atr_stop_mult=1.0)
...
grid_cells = json.load(open("grid_cells_fib_golden_zone_rejection_rr.json"))
...
with open("validate_result_fib_golden_zone_rejection_rr_qqq.json", "w") as f:
