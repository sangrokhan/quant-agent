...
best_params = {"target_cvar": 0.04, "cvar_window": 40}

report = {}
for symbol in ["BTC/USDT", "ETH/USDT"]:
    price_df = load_crypto_daily(symbol, start, end)
...
with open("validators_cvar_crypto_retune.json", "w") as f:
