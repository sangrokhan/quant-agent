...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-14_rwi_sizing_sma_trend.py")
...
with open("grid_result_rwi_sizing.json", "w") as f:
