...
spec_mod_path = "strategies/2026-09-23_spy_xlu_cash_three_way_rotation.py"
spec = importlib.util.spec_from_file_location("strat_3way", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

params = dict(lookback_days=20, rebalance_days=10)
...
with open("grid_cells_spy_xlu_cash_rotation.json") as f:
    cells = json.load(f)
grid_results = {}
for c in cells:
...
with open("validate_result_spy_xlu_cash_rotation.json", "w") as f:
