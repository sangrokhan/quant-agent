"""Strategy: Hull Moving Average (HMA) single-line crossover, wide-window fix.

Direct refinement of near-miss 2026-09-04-026 (see
knowledge_base/strategies_log.jsonl id=2026-09-09-013): original best
full-sample config (SPY, hma_window=40) failed only Sharpe (0.906 vs 1.0,
9.4% shortfall) while MDD/TC-survival/param-sensitivity all passed. A wider
window sweep (40..120) found hma_window=100 pushes both SPY (Sharpe=1.141)
and QQQ (Sharpe=1.083) above threshold, resolving the near-miss for both
symbols with much healthier trade counts (85-94 trades vs the original's
sparser near-miss sample).

Original hypothesis (id=2026-09-04-026):
