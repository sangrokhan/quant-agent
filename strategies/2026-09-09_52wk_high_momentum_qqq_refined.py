"""Strategy: 52-week-high proximity momentum, QQQ-Sharpe-fix refinement.

Direct refinement of near-miss 2026-09-03-015 (see
knowledge_base/strategies_log.jsonl id=2026-09-09-012): original config
(pct_from_high=0.02, trend_window=150) gave QQQ Sharpe=0.959 (near-miss,
0.041 below threshold) while SPY already passed. A finer parameter sweep
found pct_from_high=0.04/trend_window=200 pushes QQQ Sharpe to 1.135 while
keeping SPY passing (1.081) -- both symbols now accepted. Same
entry/exit logic as the original (see 2026-09-03_52wk_high_momentum.py),
only the default parameter values differ.

Original hypothesis (id=2026-09-03-015):
