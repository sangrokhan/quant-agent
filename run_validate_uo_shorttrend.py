...
best_params = {"trend_window": 40, "uo_sensitivity": 0.4, "deadband": 0.10}
...
for symbol in ["QQQ", "SPY"]:
    ...
    for tw in [35, 40, 45]:
        for sens in [0.3, 0.4, 0.5]:
            r = strat.generate_returns(price_df, trend_window=tw, uo_sensitivity=sens, deadband=0.10)
            try:
                import vectorbt as vbt
...
with open("validators_uo_shorttrend.json", "w") as f:
