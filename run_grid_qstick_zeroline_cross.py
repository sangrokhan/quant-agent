...
gspec = GridSpec(
    param_grid={
        "qstick_period": [5, 8, 14],
        "ema_period": [30, 50],
        "rsi_overbought_guard": [65, 70, 75],
    },
...
with open("grid_summary_qstick_zeroline_cross.json", "w") as f:
...
with open("grid_cells_qstick_zeroline_cross.json", "w") as f:
