...
spec_path = "strategies/2026-09-16_pso_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("pso_strat", spec_path)
...
configs = {
    "QQQ": {"loader": load_equity, "params": {"trend_window": 40, "stoch_period": 8, "smooth_period": 5,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.30}},
    "SPY": {"loader": load_equity, "params": {"trend_window": 40, "stoch_period": 8, "smooth_period": 5,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.30}},
    "BTC/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "stoch_period": 8, "smooth_period": 5,
             "base_exposure": 0.2, "sensitivity": 0.2, "leverage_cap": 0.5, "deadband": 0.30}},
    "ETH/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "stoch_period": 8, "smooth_period": 5,
             "base_exposure": 0.2, "sensitivity": 0.2, "leverage_cap": 0.5, "deadband": 0.30}},
}
...
with open("validators_pso_sizing.json", "w") as f:
