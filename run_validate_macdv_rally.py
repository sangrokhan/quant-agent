...
strat = load_module(os.path.join(ROOT, "strategies", "2026-09-12_macdv_rallying_stage_breakout.py"), "macdv_rally_strat")
...
best_params = dict(rally_low=50.0, rally_high=150.0, max_hold_days=30)
...
for symbol in ["QQQ", "SPY"]:
    ...
    param_grid_results = {}
    for rl in [30.0, 50.0, 70.0]:
        for rh in [130.0, 150.0, 170.0]:
            p2 = dict(rally_low=rl, rally_high=rh, max_hold_days=30)
...
with open(os.path.join(ROOT, "validators_macdv_rally.json"), "w") as f:
