...
gspec = GridSpec(
    param_grid={
        "decline_pct": [0.03, 0.05, 0.08],
        "rally_mult": [1.5, 2.0, 3.0],
...
with open("grid_summary_drop_base_rally_demand.json", "w") as f:
...
with open("grid_cells_drop_base_rally_demand.json", "w") as f:
