...
spec_mod_path = "strategies/2026-09-22_double_stochastic_trend_pullback.py"
spec = importlib.util.spec_from_file_location("strat_dstoch", spec_mod_path)
...
params = dict(oversold_thresh=30.0, atr_tp_mult=3.0, max_hold_days=15)
...
grid_cells = json.load(open("grid_cells_double_stochastic_trend_pullback.json"))
...
with open("validate_result_double_stochastic_trend_pullback_qqq.json", "w") as f:
