...
spec_mod_path = "strategies/2026-09-24_shark32_trend_continuation.py"
spec = importlib.util.spec_from_file_location("strat_shark32", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "trend_window": [10, 20, 40],
...
with open("grid_summary_shark32.json", "w") as f:
...
with open("grid_cells_shark32.json", "w") as f:
