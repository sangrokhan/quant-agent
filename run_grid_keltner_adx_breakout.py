...
spec_mod_path = "strategies/2026-09-24_keltner_adx_breakout.py"
spec = importlib.util.spec_from_file_location("strat_kcadx", spec_mod_path)
...
with open("grid_summary_keltner_adx_breakout.json", "w") as f:
...
with open("grid_cells_keltner_adx_breakout.json", "w") as f:
