...
spec = importlib.util.spec_from_file_location(
    "strat_dxycorr", "strategies/2026-09-23_dxy_btc_correlation_breakdown.py"
)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

params = dict(short_window=20, long_window=80, buffer=0.1, trend_window=50)

cells = json.load(open("grid_cells_dxy_btc_correlation_breakdown.json"))
...
with open("validators_dxy_btc_correlation_breakdown.json", "w") as f:
