...
best_params = {"trend_window": 30, "vzo_sensitivity": 0.5, "deadband": 0.10}
...
for symbol in ["QQQ", "SPY"]:
    ...
    for tw in [25, 30, 35]:
        for sens in [0.4, 0.5, 0.6]:
            r = strat.generate_returns(price_df, trend_window=tw, vzo_sensitivity=sens, deadband=0.10)
            try:
                import vectorbt as vbt
...
with open("validators_vzo_shorttrend.json", "w") as f:
