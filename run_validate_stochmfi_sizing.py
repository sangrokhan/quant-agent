...
spec_path = "strategies/2026-09-16_stochmfi_sizing_sma_trend.py"
...
configs = {
    "QQQ": {"loader": load_equity, "params": {"trend_window": 40, "mfi_period": 14, "stoch_period": 14,
             "base_exposure": 0.4, "sensitivity": 0.3, "leverage_cap": 1.0, "deadband": 0.60}},
    "SPY": {"loader": load_equity, "params": {"trend_window": 40, "mfi_period": 14, "stoch_period": 14,
             "base_exposure": 0.4, "sensitivity": 0.3, "leverage_cap": 1.0, "deadband": 0.40}},
    "BTC/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "mfi_period": 14, "stoch_period": 14,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.30}},
    "ETH/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "mfi_period": 14, "stoch_period": 14,
...
with open("validators_stochmfi_sizing.json", "w") as f:
