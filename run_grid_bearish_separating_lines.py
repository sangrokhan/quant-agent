...
spec_mod_path = "strategies/2026-09-21_bearish_separating_lines_short.py"
spec = importlib.util.spec_from_file_location("strat_bsl", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "open_match_tolerance_pct": [0.002, 0.003, 0.005],
...
with open("grid_summary_bearish_separating_lines_short.json", "w") as f:
...
with open("grid_cells_bearish_separating_lines_short.json", "w") as f:
