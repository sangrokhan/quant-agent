...
strat = load_module(os.path.join(ROOT, "strategies", "2026-09-12_ema20_pullback_reversal_swing.py"), "ema20_strat")
...
best_params = dict(pullback_pct=0.03, rsi_low=40, rsi_high=60)
...
for symbol in ["SPY", "QQQ"]:
    ...
    param_grid_results = {}
    for pb in [0.015, 0.02, 0.03]:
        for rl in [35, 40]:
            p2 = dict(pullback_pct=pb, rsi_low=rl, rsi_high=60)
...
with open(os.path.join(ROOT, "validators_ema20_pullback.json"), "w") as f:
