...
spec_mod_path = "strategies/2026-09-21_matching_low_bullish_reversal.py"
spec = importlib.util.spec_from_file_location("strat_ml", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "match_tolerance_pct": [0.002, 0.005],
        "max_hold_days": [3, 5, 8],
    },
...
with open("grid_summary_matching_low_bullish_reversal.json", "w") as f:
...
with open("grid_cells_matching_low_bullish_reversal.json", "w") as f:
