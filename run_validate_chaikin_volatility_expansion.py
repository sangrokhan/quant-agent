...
ASSET_CLASS = sys.argv[2] if len(sys.argv) > 2 else "crypto"
...
if PARAMS_JSON:
    ...
    params = dict(cv_ema_period=10, cv_lookback=15, rsi_bull_threshold=55, max_hold_days=20)
...
with open(f"validate_result_chaikin_volatility_expansion_{symname}.json", "w") as f:
