...
gspec = GridSpec(
    param_grid={
        "trend_sma_window": [10, 20, 30],
        "reward_risk_mult": [2.0, 3.0, 4.0],
        "max_hold_days": [10, 20],
    },
...
with open("grid_summary_three_bar_reversal.json", "w") as f:
...
with open("grid_cells_three_bar_reversal.json", "w") as f:
