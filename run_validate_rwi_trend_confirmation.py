...
spec_mod_path = "strategies/2026-09-24_rwi_trend_confirmation.py"
spec = importlib.util.spec_from_file_location("strat_rwi", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(rwi_period=20, entry_threshold=1.2, max_hold_days=20)
...
grid_cells = json.load(open("grid_cells_rwi_trend_confirmation.json"))
...
with open(f"validate_result_rwi_trend_confirmation_{symname}.json", "w") as f:
