...
spec_mod_path = "strategies/2026-09-22_volume_rsi_oversold_pullback_trend.py"
spec = importlib.util.spec_from_file_location("strat_vorsi_pb", spec_mod_path)
...
with open("grid_summary_volume_rsi_oversold_pullback.json", "w") as f:
...
with open("grid_cells_volume_rsi_oversold_pullback.json", "w") as f:
