...
strat = load_module(os.path.join(ROOT, "strategies", "2026-09-12_ehlers_adaptive_supersmoother_crossover.py"), "ass_strat")
...
best_params = dict(base_period=30, min_hold_days=5)
...
for symbol in ["QQQ", "SPY"]:
    ...
    for bp in [15, 20, 30]:
        for mh in [3, 5, 10]:
            p2 = dict(base_period=bp, min_hold_days=mh)
...
with open(os.path.join(ROOT, "validators_ehlers_adaptive_ss.json"), "w") as f:
