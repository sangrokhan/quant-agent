...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-14_efi_sizing_sma_trend.py")
...
gs = GridSpec(
    param_grid={
        "efi_sensitivity": [0.4, 0.6, 0.8],
        "deadband": [0.15, 0.20, 0.25],
    },
...
with open("grid_result_efi_sizing.json", "w") as f:
