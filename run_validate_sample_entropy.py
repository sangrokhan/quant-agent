...
spec = importlib.util.spec_from_file_location("strat", "strategies/2026-09-21_sample_entropy_regime_trend.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

best_params = dict(fast_window=20, slow_window=100, sampen_threshold=2.0)
...
cells = json.load(open("grid_cells_sample_entropy_regime_trend.json"))
pgr = {}
for c in cells:
...
with open("validate_result_sample_entropy_regime_qqq.json", "w") as f:
