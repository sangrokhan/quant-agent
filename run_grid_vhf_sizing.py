...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-14_vhf_sizing_sma_trend.py")
...
gs = GridSpec(
    param_grid={
        "vhf_sensitivity": [0.4, 0.6, 0.8],
        "deadband": [0.10, 0.15, 0.20],
    },
...
with open("grid_result_vhf_sizing.json", "w") as f:
