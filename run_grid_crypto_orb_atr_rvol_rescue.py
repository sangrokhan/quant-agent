...
spec_mod_path = "strategies/2026-09-22_crypto_orb_atr_rvol_rescue.py"
spec = importlib.util.spec_from_file_location("strat_orb2", spec_mod_path)
...
with open("grid_summary_crypto_orb_atr_rvol_rescue.json", "w") as f:
...
with open("grid_cells_crypto_orb_atr_rvol_rescue.json", "w") as f:
