...
spec = importlib.util.spec_from_file_location("strat", "strategies/2026-09-21_abdi_ranaldo_spike_fade.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

best_params = dict(ar_window=20, spike_pctile_threshold=0.9, hold_days=3)
SYM = "BTC/USDT"
...
cells = json.load(open("grid_cells_abdi_ranaldo_spike_fade.json"))
pgr = {}
for c in cells:
...
with open("validate_result_abdi_ranaldo_spike_fade_btc.json", "w") as f:
