...
spec_mod_path = "strategies/2026-09-21_lyapunov_hurst_regime_trend.py"
spec = importlib.util.spec_from_file_location("strat_lyap", spec_mod_path)
...
with open("grid_summary_lyapunov_hurst_regime_trend.json", "w") as f:
...
with open("grid_cells_lyapunov_hurst_regime_trend.json", "w") as f:
