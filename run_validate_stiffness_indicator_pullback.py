...
spec_mod_path = "strategies/2026-09-24_stiffness_indicator_pullback.py"
spec = importlib.util.spec_from_file_location("strat_stiff", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(stiff_threshold=70, rsi_pullback_level=45, max_hold_days=25)
...
grid_cells = json.load(open("grid_cells_stiffness_indicator_pullback.json"))
...
with open(f"validate_result_stiffness_indicator_pullback_{symname}.json", "w") as f:
