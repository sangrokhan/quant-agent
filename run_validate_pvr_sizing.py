...
spec_path = "strategies/2026-09-16_pvr_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("pvr_strat", spec_path)
...
configs = {
    "QQQ": {"loader": load_equity, "params": {"trend_window": 40, "pvr_window": 10,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.20}},
    "SPY": {"loader": load_equity, "params": {"trend_window": 40, "pvr_window": 10,
             "base_exposure": 0.4, "sensitivity": 0.3, "leverage_cap": 1.0, "deadband": 0.30}},
    "BTC/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "pvr_window": 10,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.20}},
    "ETH/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "pvr_window": 10,
...
with open("validators_pvr_sizing.json", "w") as f:
