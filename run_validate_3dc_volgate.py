...
spec = importlib.util.spec_from_file_location("strat_3dcvg", "strategies/2026-09-24_3dc_downtrend_reversal_volgate.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

params = dict(max_stop_pct=0.05, vol_regime_ratio=1.2, target_mult=1.5)
...
for symbol in ["SPY", "QQQ"]:
    ...
    cells = json.load(open("grid_cells_3dc_volgate.json"))
...
with open("validate_result_3dc_volgate_spy_qqq.json", "w") as f:
