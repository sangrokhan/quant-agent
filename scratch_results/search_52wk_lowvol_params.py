...
spec_mod = importlib.util.spec_from_file_location(
    "wk52lv", os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "strategies", "2026-09-20_52wk_high_lowvol_gate_sma_exit.py")
)
...
best = None
for lb, sma in itertools.product([63, 100, 126, 150, 189, 252], [50, 75, 100, 125, 150, 175, 200]):
    params = dict(lookback_days=lb, exit_sma_window=sma)
