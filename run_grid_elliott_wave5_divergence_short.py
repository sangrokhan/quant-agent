...
spec_mod_path = "strategies/2026-09-22_elliott_wave5_divergence_short.py"
spec = importlib.util.spec_from_file_location("strat_ew5", spec_mod_path)
...
with open("grid_summary_elliott_wave5_divergence_short.json", "w") as f:
...
with open("grid_cells_elliott_wave5_divergence_short.json", "w") as f:
