...
spec_mod_path = "strategies/2026-09-24_wad_divergence_swing_breakout.py"
spec = importlib.util.spec_from_file_location("strat_wad", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(swing_window=3, reward_risk=1.5, max_hold_bars=15)
...
grid_cells = json.load(open("grid_cells_wad_divergence_swing_breakout.json"))
...
with open(f"validate_result_wad_divergence_swing_breakout_{symname}.json", "w") as f:
