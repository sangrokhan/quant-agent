...
spec_mod_path = "strategies/2026-09-21_bearish_kicker_short.py"
spec = importlib.util.spec_from_file_location("strat_bk", spec_mod_path)
...
with open("grid_summary_bearish_kicker_short.json", "w") as f:
...
with open("grid_cells_bearish_kicker_short.json", "w") as f:
