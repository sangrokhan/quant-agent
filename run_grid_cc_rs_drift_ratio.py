...
spec_mod_path = "strategies/2026-09-21_cc_rs_drift_ratio_trend_breakout.py"
spec = importlib.util.spec_from_file_location("strat_ccrs", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "ratio_threshold": [1.3, 1.5, 1.8],
...
with open("grid_summary_cc_rs_drift_ratio.json", "w") as f:
...
with open("grid_cells_cc_rs_drift_ratio.json", "w") as f:
