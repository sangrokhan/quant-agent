...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-14_pfe_sizing_sma_trend.py")
...
with open("grid_result_pfe_sizing.json", "w") as f:
