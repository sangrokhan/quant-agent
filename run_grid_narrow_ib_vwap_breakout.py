...
spec_mod_path = "strategies/2026-09-22_narrow_ib_vwap_breakout.py"
spec = importlib.util.spec_from_file_location("strat_ib", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "ib_narrow_pct": [0.15, 0.20, 0.30],
        "ib_target_mult": [1.0, 1.5, 2.0],
    },
...
with open("grid_summary_narrow_ib_vwap_breakout.json", "w") as f:
...
with open("grid_cells_narrow_ib_vwap_breakout.json", "w") as f:
