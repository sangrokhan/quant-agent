...
spec_path = "strategies/2026-09-15_donchian_width_invvol_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("dw_strat", spec_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

start, end = datetime(2019, 1, 1), datetime(2026, 9, 1)
params = {"trend_window": 40, "donchian_window": 20, "minmax_window": 80, "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.20}
...
with open("validators_donchianwidth_qqq_fix.json", "w") as f:
