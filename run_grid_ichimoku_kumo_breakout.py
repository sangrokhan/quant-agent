...
with open("grid_summary_ichimoku_kumo_breakout_kijun_trail.json", "w") as f:
...
with open("grid_cells_ichimoku_kumo_breakout_kijun_trail.json", "w") as f:
