...
gspec = GridSpec(
    ...
    symbols={"equity": ["TQQQ"], "crypto": ["BTC/USDT", "ETH/USDT"]},
    vol_regime_splits=3,
)
...
with open("grid_summary_tqqq_tecl_laggard_regime.json", "w") as f:
...
with open("grid_cells_tqqq_tecl_laggard_regime.json", "w") as f:
