...
spec_path = "strategies/2026-09-14_ttf_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("ttf_strat", spec_path)
...
configs = {
    "QQQ": ("equity", {"sensitivity": 0.3, "deadband": 0.25, "leverage_cap": 1.0}),
    "SPY": ("equity", {"sensitivity": 0.3, "deadband": 0.30, "leverage_cap": 1.0}),
    "BTC/USDT": ("crypto", {"sensitivity": 0.3, "deadband": 0.25, "leverage_cap": 0.4}),
    "ETH/USDT": ("crypto", {"sensitivity": 0.5, "deadband": 0.15, "leverage_cap": 0.4}),
}
...
with open("validators_ttf_sizing.json", "w") as f:
