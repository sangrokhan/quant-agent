...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-16_volswitch_invvol_sizing_sma_trend.py")
...
with open("grid_result_volswitch_sizing.json", "w") as f:
