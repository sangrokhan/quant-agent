...
spec_mod_path = "strategies/2026-09-24_gaussian_filter_dual_trend.py"
spec = importlib.util.spec_from_file_location("strat_gauss", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(fast_period=10, slow_period=30, distance_threshold_pct=0.4, period=20, poles=4, max_hold_days=15)
...
grid_cells = json.load(open("grid_cells_gaussian_filter_dual_trend.json"))
...
with open(f"validate_result_gaussian_filter_dual_trend_{symname}.json", "w") as f:
