...
spec_mod = importlib.util.spec_from_file_location(
    "strat", "strategies/2026-09-22_reverse_elder_impulse_minhold_rescue.py"
)
...
gs = GridSpec(
    param_grid={"min_hold_days": [5, 10, 15]},
...
with open("grid_cells_reverse_elder_impulse_minhold.json", "w") as f:
    json.dump(cells, f, indent=2, default=str)

summary = result.summary()
with open("grid_summary_reverse_elder_impulse_minhold.json", "w") as f:
