...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-16_eco_sizing_sma_trend.py")
...
with open("grid_result_eco_sizing.json", "w") as f:
