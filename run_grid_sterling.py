...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-13_sterling_ratio_sizing_sma_trend.py")
...
gs = GridSpec(
    param_grid={
        "sterling_reference": [0.3, 0.5, 0.8],
        "n_largest": [2, 3],
    },
...
with open("grid_result_sterling.json", "w") as f:
