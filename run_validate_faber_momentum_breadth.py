...
params = dict(fast_months=3, slow_months=10, min_breadth=1)
...
grid_cells = json.load(open("grid_cells_faber_momentum_breadth.json"))
...
with open(f"validate_result_faber_momentum_breadth_{SYMBOL}.json", "w") as f:
