...
params = dict(lookback_days=20, rebalance_days=5)
...
with open("grid_cells_weekly_spy_xlu_rotation.json") as f:
    cells = json.load(f)
grid_results = {}
for c in cells:
...
with open("validate_result_weekly_spy_xlu_rotation.json", "w") as f:
