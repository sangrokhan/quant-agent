...
best_params = dict(rvi_period=10, avg_period=14, smoothing_period=20, max_hold_days=20)
...
for symbol in ["QQQ", "SPY"]:
    ...
    for sp in [10, 20, 30]:
        for rp in [7, 10, 14]:
            p2 = dict(rvi_period=rp, avg_period=14, smoothing_period=sp, max_hold_days=20)
...
with open(os.path.join(ROOT, "validators_dorsey_inertia.json"), "w") as f:
