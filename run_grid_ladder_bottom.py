...
spec_mod_path = "strategies/2026-09-21_ladder_bottom_long.py"
spec = importlib.util.spec_from_file_location("strat_lb", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "short_body_max_pct": [0.25, 0.35, 0.45],
...
with open("grid_summary_ladder_bottom_long.json", "w") as f:
...
with open("grid_cells_ladder_bottom_long.json", "w") as f:
