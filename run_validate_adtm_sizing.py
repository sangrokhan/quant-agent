...
spec_path = "strategies/2026-09-16_adtm_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("adtm_strat", spec_path)
...
configs = {
    "QQQ": {"loader": load_equity, "params": {"trend_window": 40, "adtm_window": 23,
             "base_exposure": 0.4, "sensitivity": 0.5, "leverage_cap": 1.0, "deadband": 0.15}},
    "SPY": {"loader": load_equity, "params": {"trend_window": 40, "adtm_window": 23,
             "base_exposure": 0.4, "sensitivity": 0.4, "leverage_cap": 1.0, "deadband": 0.30}},
    "BTC/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "adtm_window": 23,
             "base_exposure": 0.2, "sensitivity": 0.15, "leverage_cap": 0.5, "deadband": 0.15}},
    "ETH/USDT": {"loader": load_crypto_daily, "params": {"trend_window": 40, "adtm_window": 23,
             "base_exposure": 0.2, "sensitivity": 0.15, "leverage_cap": 0.5, "deadband": 0.25}},
}
...
with open("validators_adtm_sizing.json", "w") as f:
