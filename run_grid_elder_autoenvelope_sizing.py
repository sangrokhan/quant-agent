...
spec_path = os.path.join(os.path.dirname(__file__), "strategies", "2026-09-16_elder_autoenvelope_sizing_sma_trend.py")
...
with open("grid_result_elder_autoenvelope_sizing.json", "w") as f:
