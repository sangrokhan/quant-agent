...
spec_mod_path = "strategies/2026-09-22_brooks_wedge_reversal_short.py"
spec = importlib.util.spec_from_file_location("strat_wedge", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "pivot_window": [3, 4, 6, 8],
        "max_hold_days": [15, 25],
    },
...
with open("grid_summary_brooks_wedge_reversal_short.json", "w") as f:
...
with open("grid_cells_brooks_wedge_reversal_short.json", "w") as f:
