...
spec_mod_path = "strategies/2026-09-24_vortex_crossover_tpsl.py"
spec = importlib.util.spec_from_file_location("strat_vtpsl", spec_mod_path)
...
with open("grid_summary_vortex_crossover_tpsl.json", "w") as f:
...
with open("grid_cells_vortex_crossover_tpsl.json", "w") as f:
