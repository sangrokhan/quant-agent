...
for sym, params in configs.items():
    ...
    for rw in [13, 20]:
        for sens in [0.4, 0.6]:
            r = strat.generate_returns(price_df, smi_range_window=rw, smi_sensitivity=sens, base_exposure=params["base_exposure"], deadband=params["deadband"],
...
with open("validators_smi_sizing_crypto_lev.json", "w") as f:
