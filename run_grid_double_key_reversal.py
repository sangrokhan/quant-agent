...
spec_mod = importlib.util.spec_from_file_location(
    "double_key_reversal",
    os.path.join("strategies", "2026-09-26_bulkowski_double_key_reversal.py"),
)
...
spec = GridSpec(
    param_grid={
        ...
        "body_pct": [0.15, 0.25, 0.35],
        "height_mult": [1.0, 2.0, 3.0],
    },
...
with open("grid_result_double_key_reversal.json", "w") as f:
    json.dump([c.__dict__ for c in result.cells], f, default=str)
with open("grid_summary_double_key_reversal.json", "w") as f:
