...
spec = importlib.util.spec_from_file_location("strat_tds", "strategies/2026-09-24_td_sequential_buy_setup.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

SYMBOL = "QQQ"
params = {"max_hold_days": 5, "stop_buffer_pct": 0.01}
...
grid_cells = json.load(open("grid_cells_td_sequential_buy_setup.json"))
param_grid_results = {}
for c in grid_cells:
...
with open("validate_result_td_sequential_buy_setup_qqq.json", "w") as f:
