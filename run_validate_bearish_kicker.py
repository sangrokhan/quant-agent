...
spec = importlib.util.spec_from_file_location("strat_bk", "strategies/2026-09-21_bearish_kicker_short.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

params = dict(trend_window=50, tall_body_min_pct=0.4, target_atr_mult=2.0)
...
cells = json.load(open("grid_cells_bearish_kicker_short.json"))
...
with open("validators_bearish_kicker_qqq.json","w") as f:
