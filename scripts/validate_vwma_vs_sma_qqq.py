...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-17_vwma_vs_sma_crossover_calhoun.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

price = load_equity("QQQ", datetime(2019,1,1), datetime(2026,9,1))

params = dict(vwma_length=50, ma_length=100, max_hold_days=40)
...
cells = json.load(open("grid_cells_vwma_vs_sma.json"))
...
with open("validate_result_vwma_vs_sma_qqq.json","w") as f:
