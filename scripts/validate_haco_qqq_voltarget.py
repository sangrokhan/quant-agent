...
spec = importlib.util.spec_from_file_location("strat_mod", "strategies/2026-09-17_haco_qqq_voltarget_rescue.py")
...
params = dict(target_vol=0.15, max_leverage=1.0)
...
param_grid_results = {}
price_df_qqq = load_equity("QQQ", start=datetime(2019, 1, 1), end=datetime(2026, 9, 1), interval="1d")
for tv in [0.10, 0.15, 0.20]:
    p2 = dict(target_vol=tv, max_leverage=1.0)
...
with open("/tmp/haco_qqq_voltarget_validators.json", "w") as f:
