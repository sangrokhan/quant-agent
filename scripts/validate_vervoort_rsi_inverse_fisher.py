...
per_symbol_params = {
    "QQQ": {"rsi_period": 4, "trend_window": 100, "max_hold_days": 10},
    "SPY": {"rsi_period": 3, "trend_window": 50, "max_hold_days": 10},
}
...
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "validators_vervoort_rsi_inverse_fisher.json"), "w") as f:
