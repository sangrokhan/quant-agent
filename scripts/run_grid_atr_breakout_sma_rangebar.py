...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-17_atr_breakout_sma100_rangebar_calhoun.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

spec = GridSpec(
    param_grid={
        "moving_avg_length": [50, 100],
        "bar_size_multiplier": [1.3, 1.5, 1.8],
        "max_hold_days": [15, 25],
    },
...
with open("grid_result_atr_breakout_sma_rangebar.json","w") as f:
...
with open("grid_cells_atr_breakout_sma_rangebar.json","w") as f:
