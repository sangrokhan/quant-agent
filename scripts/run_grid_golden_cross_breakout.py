...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-17_golden_cross_breakout_volume_calhoun.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

spec = GridSpec(
    param_grid={
        "max_bars_since_cross": [10, 20],
        "volume_mult_required": [1.1, 1.3, 1.5],
        "max_hold_days": [30, 40],
    },
...
with open("grid_result_golden_cross_breakout.json","w") as f:
...
with open("grid_cells_golden_cross_breakout.json","w") as f:
