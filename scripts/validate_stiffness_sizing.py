...
spec = importlib.util.spec_from_file_location("strat_mod", "strategies/2026-09-17_stiffness_sizing_sma_trend.py")
...
configs = {
    "QQQ": dict(loader=load_equity, sym="QQQ", params=dict(trend_window=30, stiffness_period=80, sensitivity=0.5, deadband=0.20)),
    "SPY": dict(loader=load_equity, sym="SPY", params=dict(trend_window=40, stiffness_period=80, sensitivity=0.5, deadband=0.15)),
    "BTC": dict(loader=load_crypto, sym="BTC/USDT", params=dict(trend_window=50, stiffness_period=80, sensitivity=0.5, deadband=0.20, leverage_cap=0.3, base_exposure=0.15)),
    "ETH": dict(loader=load_crypto, sym="ETH/USDT", params=dict(trend_window=40, stiffness_period=80, sensitivity=0.5, deadband=0.15, leverage_cap=0.3, base_exposure=0.15)),
}
...
with open("/tmp/stiffness_validators.json", "w") as f:
