...
spec = GridSpec(
    param_grid={
        ...
        "vol_surge_mult": [1.5, 2.0],
        "min_body_ratio": [0.5, 0.6],
    },
...
with open("grid_result_donchian_volume_surge.json","w") as f:
    json.dump(summary, f, indent=2, default=str)

# save cells too for param sensitivity
...
with open("grid_cells_donchian_volume_surge.json","w") as f:
