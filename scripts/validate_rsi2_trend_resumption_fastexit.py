...
spec = importlib.util.spec_from_file_location("strat_mod", "strategies/2026-09-17_rsi2_trend_resumption_fastexit.py")
...
params = dict(rsi_entry=15.0, rsi_exit=50.0, trend_window=200, max_hold_days=15, rsi_window=2)
...
with open("/tmp/rsi2_tr_fastexit_validators.json", "w") as f:
