...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-17_macd_wma_ema_aroon_composite.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

price = load_equity("SPY", datetime(2019,1,1), datetime(2026,9,1))

params = dict(aroon_length=25, max_hold_days=10)
...
cells = json.load(open("grid_cells_macd_wma_ema_aroon.json"))
...
with open("validate_result_macd_wma_ema_aroon_spy.json","w") as f:
