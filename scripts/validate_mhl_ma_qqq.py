...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-17_mhl_moving_average_crossover.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

price = load_equity("QQQ", datetime(2019,1,1), datetime(2026,9,1))

params = dict(avg_type="ema", mhl_length=10, moving_avg_length=75)
...
cells = json.load(open("grid_cells_mhl_ma.json"))
...
with open("validate_result_mhl_ma_qqq.json","w") as f:
