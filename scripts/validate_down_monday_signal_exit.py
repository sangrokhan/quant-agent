...
spec = importlib.util.spec_from_file_location("strat_mod", "strategies/2026-09-17_down_monday_signal_exit_reversal.py")
...
with open("/tmp/down_monday_signal_exit_validators.json", "w") as f:
