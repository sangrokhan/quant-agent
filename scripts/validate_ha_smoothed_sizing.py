...
configs = {
    "QQQ": dict(loader=load_equity, sym="QQQ", params=dict(trend_window=50, smooth_period=20, sensitivity=0.5, deadband=0.20)),
    "SPY": dict(loader=load_equity, sym="SPY", params=dict(trend_window=30, smooth_period=6, sensitivity=0.7, deadband=0.20)),
    "BTC": dict(loader=load_crypto, sym="BTC/USDT", params=dict(trend_window=40, smooth_period=20, sensitivity=0.5, deadband=0.20, leverage_cap=0.3, base_exposure=0.15)),
    "ETH": dict(loader=load_crypto, sym="ETH/USDT", params=dict(trend_window=50, smooth_period=6, sensitivity=0.5, deadband=0.20, leverage_cap=0.3, base_exposure=0.15)),
}
...
with open("/tmp/ha_smoothed_validators.json", "w") as f:
