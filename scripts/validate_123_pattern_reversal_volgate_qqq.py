...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-18_123_pattern_reversal_volgate.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

price = load_equity("QQQ", datetime(2015,1,1), datetime(2026,9,1))

params = dict(max_hold_days=30, vol_regime_ratio=0.8)
...
cells = json.load(open("grid_cells_123_pattern_reversal_volgate.json"))
...
with open("validate_result_123_pattern_reversal_volgate_qqq.json","w") as f:
