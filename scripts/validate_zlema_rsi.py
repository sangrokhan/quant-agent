...
spec = importlib.util.spec_from_file_location("strat_mod", "strategies/2026-09-16_zlema_rsi_crossover_trend.py")
...
params = dict(fast_len=3, slow_len=10, trend_window=200)
...
with open("/tmp/zlema_rsi_validators.json","w") as f:
