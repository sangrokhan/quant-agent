...
spec_mod = importlib.util.spec_from_file_location("strat", "strategies/2026-09-18_key_reversal_day.py")
strat = importlib.util.module_from_spec(spec_mod)
spec_mod.loader.exec_module(strat)

price = load_equity("SPY", datetime(2015,1,1), datetime(2026,9,1))

params = dict(max_hold_days=24)
...
cells = json.load(open("grid_cells_key_reversal_day.json"))
...
with open("validate_result_key_reversal_day_spy.json","w") as f:
