...
params = dict(hedge_symbol="SPY", fast_length=8, slow_length=40, max_hold_days=15)
...
cells = json.load(open("grid_cells_pairs_ratio_pullback.json"))
...
with open("validate_result_pairs_ratio_pullback_qqq.json","w") as f:
