...
with open("/tmp/vpt_grid_summary.json", "w") as f:
    json.dump(summary, f, default=str)

# Also dump all cells for later param sensitivity analysis
cells = [
    {
...
with open("/tmp/vpt_grid_cells.json", "w") as f:
