...
spec_mod_path = "strategies/2026-09-24_aroon_updown_strength_crossover.py"
spec = importlib.util.spec_from_file_location("strat_aroon2", spec_mod_path)
...
if PARAMS_JSON:
    ...
    params = dict(aroon_period=14, entry_strength_threshold=70, exit_threshold=50, max_hold_days=15)
...
grid_cells = json.load(open("grid_cells_aroon_updown_strength_crossover.json"))
...
with open(f"validate_result_aroon_updown_strength_crossover_{symname}.json", "w") as f:
