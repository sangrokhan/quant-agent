...
spec_path = "strategies/2026-09-14_elderray_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("elderray_strat", spec_path)
...
configs = {
    "QQQ": ("equity", {"sensitivity": 0.5, "deadband": 0.25}),
    "SPY": ("equity", {"sensitivity": 0.5, "deadband": 0.25}),
    "BTC/USDT": ("crypto", {"sensitivity": 0.5, "deadband": 0.10}),
}
...
with open("validators_elderray_sizing.json", "w") as f:
