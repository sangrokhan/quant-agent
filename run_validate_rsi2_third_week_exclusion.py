...
spec_mod_path = "strategies/2026-09-23_rsi2_third_week_exclusion_filter.py"
spec = importlib.util.spec_from_file_location("strat_rsi2tw", spec_mod_path)
...
params = dict(entry_threshold=25, exit_bars=8)
...
grid_cells = json.load(open("grid_cells_rsi2_third_week_exclusion.json"))
...
with open(f"validate_result_rsi2_third_week_exclusion_{SYMBOL.replace('/','')}.json", "w") as f:
