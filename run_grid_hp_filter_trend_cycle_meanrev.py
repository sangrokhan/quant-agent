...
spec_mod_path = "strategies/2026-09-24_hp_filter_trend_cycle_meanrev.py"
...
with open("grid_summary_hp_filter_trend_cycle_meanrev.json", "w") as f:
...
with open("grid_cells_hp_filter_trend_cycle_meanrev.json", "w") as f:
