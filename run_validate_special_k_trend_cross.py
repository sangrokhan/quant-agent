...
spec = importlib.util.spec_from_file_location("strat_speck", "strategies/2026-09-24_special_k_trend_cross.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

SYMBOL = "SPY"
params = {"max_hold_days": 40, "trend_ema": 100}
...
grid_cells = json.load(open("grid_cells_special_k_trend_cross.json"))
param_grid_results = {}
for c in grid_cells:
...
with open("validate_result_special_k_trend_cross_spy.json", "w") as f:
