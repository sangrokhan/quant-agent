...
spec_mod_path = "strategies/2026-09-21_ema_13_48_crossover.py"
spec = importlib.util.spec_from_file_location("strat_ema1348", spec_mod_path)
...
with open("grid_summary_ema1348.json", "w") as f:
...
with open("grid_cells_ema1348.json", "w") as f:
