...
spec_mod_path = "strategies/2026-09-24_stochrsi_oversold_exit_sma200_gate.py"
spec = importlib.util.spec_from_file_location("strat_srsi", spec_mod_path)
...
with open("grid_summary_stochrsi_oversold_exit_sma200_gate.json", "w") as f:
...
with open("grid_cells_stochrsi_oversold_exit_sma200_gate.json", "w") as f:
