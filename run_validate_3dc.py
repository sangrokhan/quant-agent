...
spec = importlib.util.spec_from_file_location("strat_3dc", "strategies/2026-09-24_3dc_downtrend_reversal.py")
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

params = dict(trend_window=10, compression_ratio=0.5, target_mult=1.5)
...
for symbol in ["SPY", "QQQ"]:
    ...
    cells = json.load(open("grid_cells_3dc.json"))
...
with open("validate_result_3dc_spy_qqq.json", "w") as f:
