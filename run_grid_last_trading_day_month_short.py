...
spec_mod_path = "strategies/2026-09-23_last_trading_day_month_short.py"
spec = importlib.util.spec_from_file_location("strat_ltd", spec_mod_path)
...
with open("grid_summary_last_trading_day_month_short.json", "w") as f:
...
with open("grid_cells_last_trading_day_month_short.json", "w") as f:
