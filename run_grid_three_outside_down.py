...
spec_mod_path = "strategies/2026-09-21_three_outside_down_short.py"
spec = importlib.util.spec_from_file_location("strat_tod", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "small_body_max_pct": [0.3, 0.4, 0.5],
...
with open("grid_summary_three_outside_down_short.json", "w") as f:
...
with open("grid_cells_three_outside_down_short.json", "w") as f:
