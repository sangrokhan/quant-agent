...
spec_mod_path = "strategies/2026-09-22_elliott_wave3_breakout.py"
spec = importlib.util.spec_from_file_location("strat_ew3", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        "pivot_window": [3, 5, 8],
        "extension_mult": [1.272, 1.618, 2.0],
    },
...
with open("grid_summary_elliott_wave3_breakout.json", "w") as f:
...
with open("grid_cells_elliott_wave3_breakout.json", "w") as f:
