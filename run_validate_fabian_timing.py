...
spec_mod_path = "strategies/2026-09-22_fabian_timing_model_intermarket.py"
spec = importlib.util.spec_from_file_location("strat_fabian", spec_mod_path)
...
grid_cells = json.load(open("grid_cells_fabian_timing.json"))
...
with open(f"validate_result_fabian_timing_{SYMBOL}.json", "w") as f:
