...
spec_mod_path = "strategies/2026-09-22_percentile_channel_stoploss_rescue.py"
spec = importlib.util.spec_from_file_location("strat_pcr", spec_mod_path)
...
params = dict(window=252, entry_threshold=0.7, exit_threshold=0.25, rebalance_days=21, stop_loss_pct=0.05)
...
grid_cells = json.load(open("grid_cells_percentile_channel_stoploss_rescue.json"))
...
with open("validate_result_percentile_channel_rescue_qqq.json", "w") as f:
