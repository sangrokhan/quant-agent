...
spec_mod_path = "strategies/2026-09-23_double_death_cross_triple_sma.py"
spec = importlib.util.spec_from_file_location("strat_ddc", spec_mod_path)
...
params = dict(sma_fast=50, sma_mid=100, sma_slow=200)
...
grid_cells = json.load(open("grid_cells_double_death_cross.json"))
...
with open(f"validate_result_double_death_cross_{SYMBOL}.json", "w") as f:
