...
spec_mod_path = "strategies/2026-09-24_macd_hist_4day_exhaustion.py"
spec = importlib.util.spec_from_file_location("strat_macd_hist", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "hist_decline_days": [3, 4, 5],
        "max_hold_days": [7, 10],
    },
...
with open("grid_summary_macd_hist_4day_exhaustion.json", "w") as f:
...
with open("grid_cells_macd_hist_4day_exhaustion.json", "w") as f:
