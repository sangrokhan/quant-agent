...
gspec = GridSpec(
    param_grid={
        "atr_compress_pct": [0.05, 0.10, 0.20],
...
with open("grid_summary_inside_day_atr_compression_breakout.json", "w") as f:
...
with open("grid_cells_inside_day_atr_compression_breakout.json", "w") as f:
