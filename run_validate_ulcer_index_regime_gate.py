...
if PARAMS_JSON:
    ...
    params = dict(ui_window=10, ui_gate_percentile=0.5, max_hold_days=15)
...
grid_cells = json.load(open("grid_cells_ulcer_index_regime_gate.json"))
...
with open(f"validate_result_ulcer_index_regime_gate_{symname}.json", "w") as f:
