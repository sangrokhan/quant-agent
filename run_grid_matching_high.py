...
spec_mod_path = "strategies/2026-09-21_matching_high_short.py"
spec = importlib.util.spec_from_file_location("strat_mh", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "match_tolerance_pct": [0.002, 0.003, 0.005],
...
with open("grid_summary_matching_high_short.json", "w") as f:
...
with open("grid_cells_matching_high_short.json", "w") as f:
