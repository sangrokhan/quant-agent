...
spec_mod_path = "strategies/2026-09-24_3dc_downtrend_reversal.py"
spec = importlib.util.spec_from_file_location("strat_3dc", spec_mod_path)
...
gspec = GridSpec(
    param_grid={
        ...
        "compression_ratio": [0.25, 0.33, 0.5],
        "target_mult": [1.5, 2.0],
    },
...
with open("grid_summary_3dc.json", "w") as f:
...
with open("grid_cells_3dc.json", "w") as f:
