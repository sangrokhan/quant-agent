...
spec_path = "strategies/2026-09-15_alma_dist_sizing_sma_trend.py"
spec = importlib.util.spec_from_file_location("alma_strat", spec_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

start, end = datetime(2019, 1, 1), datetime(2026, 9, 1)
params = {"trend_window": 40, "alma_window": 20, "alma_offset": 0.85, "alma_sigma": 6.0,
          "zscore_window": 100, "base_exposure": 0.2, "sensitivity": 0.3, "leverage_cap": 0.5, "deadband": 0.20}
price_df = load_crypto_daily("ETH/USDT", start, end)
...
wf_ev = {"metric": "walk_forward_pass_fraction", "value": wf_pass_fraction, "threshold": 0.75, "n_splits": n_splits, "per_split_passed": wf_results}
...
with open("validators_alma_eth_fix.json", "w") as f:
