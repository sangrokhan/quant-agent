...
spec_mod_path = "strategies/2026-09-24_high_wave_yearly_low_gapdown_short.py"
spec = importlib.util.spec_from_file_location("strat_hw", spec_mod_path)
strat = importlib.util.module_from_spec(spec)
spec.loader.exec_module(strat)

gspec = GridSpec(
    param_grid={
        "shadow_min_pct": [0.25, 0.3, 0.4],
...
with open("grid_summary_high_wave.json", "w") as f:
...
with open("grid_cells_high_wave.json", "w") as f:
