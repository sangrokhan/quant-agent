...
params = dict(skew_threshold=135, vix_threshold=15, trend_window=50)

cells = json.load(open("grid_cells_vix_skew_divergence.json"))
...
with open("validators_vix_skew_divergence.json", "w") as f:
