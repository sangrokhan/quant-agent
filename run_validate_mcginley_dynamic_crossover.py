...
if PARAMS_JSON:
    ...
    params = dict(md_period=30, rsi_threshold=55, max_hold_days=15)
...
grid_cells = json.load(open("grid_cells_mcginley_dynamic_crossover.json"))
...
with open(f"validate_result_mcginley_dynamic_crossover_{symname}.json", "w") as f:
